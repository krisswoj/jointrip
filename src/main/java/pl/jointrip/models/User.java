...
public class User {
    ...
    @OneToMany(mappedBy = "tripMember", cascade = CascadeType.ALL)@JsonManagedReference
    private List<TripMember> tripMember;
    @ManyToMany(cascade = CascadeType.ALL)@JoinTable(name = "user_role", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "role_id"))
